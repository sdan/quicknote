...
public class QuickNote{
	...
	public QuickNote(){
		...
		buttonStart = new JButton("Continue", icon);
		//buttonStart.setVerticalTextPosition(SwingConstants.TOP);
		...
		label4.setBounds(295, 25, 400, 100);
		frame.add(label4);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==buttonStart){
				...
				if(toContinue){
					...
					label5.setBounds(295, 25, 400, 100);
					frame.add(label5);
